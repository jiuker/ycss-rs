...
.bs-10-15{background-size:10px 15px;}
.b-1-001{border:1px solid #001;}
.br-1-123{border-right:1px solid #123;}
.o-1-000121{outline:#000121 dotted 1px;}
.c-fff{color:#fff;}
...
.h10{height:10%;}
.w10{width:10%;}
.maxh-13{max-height:13px;}
.maxw-20{max-width:20px;}
.minh-5{min-height:5px;}
